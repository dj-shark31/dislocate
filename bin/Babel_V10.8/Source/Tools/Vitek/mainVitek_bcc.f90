PROGRAM Vitek
  ...
  ! ---- Input parameters for screw dislocation in bcc lattice -----
  ...
  DO i=1, im
     IF (3.d0*Modulo(xp(3,i)-z0,bz).LT.bz) &
             WRITE(62,'(3g14.6)') xp(1:3,i)
  END DO
  WRITE(62,*) 
  ! Atom positions corresponding to 2nd (111) plane
  DO i=1, im
     IF ( (3.d0*Modulo(xp(3,i)-z0,bz).GE.bz).AND. (3.d0*Modulo(xp(3,i)-z0,bz).LT.2.d0*bz) ) &
             WRITE(62,'(3g14.6)') xp(1:3,i)
  END DO
  WRITE(62,*)
  ...
  ELSE
          ...
          WRITE(60,'(3a)') 'plot "', Trim(pointFile), '" u 1:2 every :3::0 w p pt 31 lc rgb "black",\'
          WRITE(60,'(3a)') '     "', Trim(pointFile), '" u 1:2 every :3::1 w p pt 65 lc rgb "black",\'
          WRITE(60,'(3a)') '     "', Trim(pointFile), '" u 1:2 every :3::2 w p pt 31 lc rgb "grey",\'
  ...
  ELSE
          ...
          WRITE(61,'(3a)') '     "', Trim(pointFile), '" u 1:2 every :3::2 w p pt 31 lc rgb "grey",\'
