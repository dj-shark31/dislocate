...
def main():
    ...
    parser.add_argument('--babel_path', default=abspath_from_script('../bin/Babel_V10.8/bin/babel'))
    ...
    for i in range(len(args.xpos)):
        ...
        with open(abspath_from_script("input.babel_S"), 'r') as f:
            content = f.read()
    ...
    if args.analyze_core == "true":
        ...
        analyze_cmd = [
            "python",
            abspath_from_script("../core_analysis/analyze_core.py"),
