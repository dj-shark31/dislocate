...
def main():
    ...
    parser.add_argument('--thickness', type=int, required=True, help='Cell thickness (number of unit cells in z)')
    parser.add_argument('--a0', required=True, help='Lattice parameter a0 (z direction)')
    parser.add_argument('--natom', type=int, required=True, help='Number of atoms in cell')
    parser.add_argument('--tmp_babel', required=True, help='Temporary Babel file')
    parser.add_argument('--tmp_stab', required=True, help='Temporary stability file')
    parser.add_argument('--tmp_dxa', required=True, help='Temporary DXA file')
    parser.add_argument('--tmp_fitting', required=True, help='Temporary fitting file')
    parser.add_argument('--tmp_energy_stress', required=True, help='Temporary EnergyStress file')
    parser.add_argument('--output_file', required=True, help='Output file')
    parser.add_argument('--energy_stress', required=True, help='Whether to include EnergyStress data (true/false)')
    parser.add_argument('--fitting', required=True, help='Whether to include fitting data (true/false)')
    parser.add_argument('--ovito', required=True, help='Whether to include OVITO data (true/false)')
    parser.add_argument('--nye', required=True, help='Whether to include Nye tensor data (true/false)')
    parser.add_argument('--pbc', required=True, help='Whether periodic boundary conditions are used (true/false)')
